...
\end{enumerate}
 ...
 \begin{enumerate}
   ...
   \newline 2/28
   \begin{itemize}
   \item[$\square$] Generate basic graphical interface with simple menu, using Piston (one class/file).
   \item[$\square$] Beginnings of the Command class (input handler) written and incorporate with above.
   \item[$\square$] Have skeleton of Game loop written.
   \item[$\square$] Have a list of NPCs/items we would like to include.
   \end{itemize}
   3/21
   \begin{itemize}
